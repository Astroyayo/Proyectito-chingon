...
ALTER TABLE usersadd foreign key(userType) references userTypes(id);
ALTER TABLE paymentsadd foreign key(id_debt) references debts(id);
ALTER TABLE paymentsadd foreign key(id_user) references users(id);
ALTER TABLE debtDetailsadd foreign key(debtor) references users(id);
ALTER TABLE debtDetailsadd foreign key(id_debt) references debts(id);
